			...
			choices: [
				{
					...
					value: 'Yes Mouse and keyboard is enabled for this server',
				},
				{
					name: 'How often does the Server restart?',
					value: 'the server is on a automatic restart every 4 hours'
				},
				{
					name: 'how do i access the map in the server?',
					value: 'if your on keyboard and mouse you can just press m, controller you need tourst map'
				}
			]
		},
		{
